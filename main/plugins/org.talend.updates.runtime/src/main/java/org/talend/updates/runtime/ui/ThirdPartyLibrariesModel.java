 ...
 *
 */
public class ThirdPartyLibrariesModel {
    ...
    public void setAvaliableExtraFeatures(IObservableSet availableExtraFeatures) {
        this.availableExtraFeatures = availableExtraFeatures;
    }
     ...
     * @param extraFeatures
     */
    public ThirdPartyLibrariesModel(Set<ExtraFeature> extraFeatures) {
